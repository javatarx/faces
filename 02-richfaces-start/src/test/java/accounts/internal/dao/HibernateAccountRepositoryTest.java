...
import accounts.internal.dao.HibernateAccountRepository;
 ...
 */
public class HibernateAccountRepositoryTest extends TestCase {
	...
	public void testGetAllAccounts() {
		...
		assertEquals("Wrong number of accounts", 20, accounts.size());
	}

	public void testGetAccount() {
		Account account = accountRepository.getAccount(Long.valueOf(1));
	...
	public void testUpdateAccount() {
		Account oldAccount = accountRepository.getAccount(Long.valueOf(1));
		oldAccount.setName("Ben Hale");
		accountRepository.update(oldAccount);
		Account newAccount = accountRepository.getAccount(Long.valueOf(1));
	...
	public void testUpdateAccountBeneficiaries() {
		...
		accountRepository.updateBeneficiaryAllocationPercentages(Long.valueOf(1), allocationPercentages);
		Account account = accountRepository.getAccount(Long.valueOf(1));
	...
	public void testAddBeneficiary() {
		accountRepository.addBeneficiary(Long.valueOf(1), "Ben");
		Account account = accountRepository.getAccount(Long.valueOf(1));
	...
	public void testRemoveBeneficiary() {
		...
		accountRepository.removeBeneficiary(Long.valueOf(1), "Annabelle", allocationPercentages);
		Account account = accountRepository.getAccount(Long.valueOf(1));
	...
	private SessionFactory createTestSessionFactory() throws Exception {
		...
		Resource[] mappingLocations = new ClassPathResource[] {
				new ClassPathResource("Account.hbm.xml", HibernateAccountRepository.class),
				new ClassPathResource("Beneficiary.hbm.xml", HibernateAccountRepository.class) };
