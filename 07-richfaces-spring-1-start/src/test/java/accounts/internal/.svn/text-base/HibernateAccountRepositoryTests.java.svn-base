...
public class HibernateAccountRepositoryTests extends TestCase {
	...
	public void testGetAccount() {
		Account account = accountRepository.getAccount(Long.valueOf(0));
	...
	public void testUpdateAccount() {
		Account oldAccount = accountRepository.getAccount(Long.valueOf(0));
		oldAccount.setName("Ben Hale");
		accountRepository.update(oldAccount);
		Account newAccount = accountRepository.getAccount(Long.valueOf(0));
	...
	public void testUpdateAccountBeneficiaries() {
		...
		accountRepository.updateBeneficiaryAllocationPercentages(Long.valueOf(0), allocationPercentages);
		Account account = accountRepository.getAccount(Long.valueOf(0));
	...
	public void testAddBeneficiary() {
		accountRepository.addBeneficiary(Long.valueOf(0), "Ben");
		Account account = accountRepository.getAccount(Long.valueOf(0));
	...
	public void testRemoveBeneficiary() {
		...
		accountRepository.removeBeneficiary(Long.valueOf(0), "Annabelle", allocationPercentages);
		Account account = accountRepository.getAccount(Long.valueOf(0));
